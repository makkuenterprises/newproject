...
@php
    ...
    $date = date('d-m-y');
    $orders = DB::table('itemorders')->where('date',$date)->sum('amount');
    
    
    $month = date('F');
    $month = DB::table('itemorders')->where('month',$month)->sum('amount');
    
    $year = date('Y');
    $year = DB::table('itemorders')->where('year',$year)->sum('amount');
    
    $today_deleivery = DB::table('itemorders')->where('status',3)->sum('amount');
    
    $today_return = DB::table('itemorders')->where('return_order',2)->sum('amount');
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">This Month's Sales</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">This Year's Sales</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Today's Deleivery</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">{{  $today_deleivery }}</div>
                      <!--<div class="mt-2 mb-0 text-muted text-xs">-->
             ...
             <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Today's Return</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">{{   $today_return }}</div>
                      <!--<div class="mt-2 mb-0 text-muted text-xs">-->
                      <!--  <span class="text-danger mr-2"><i class="fas fa-arrow-down"></i> 1.10%</span>-->
                      <!--  <span>Since yesterday</span>-->
                      <!--</div>-->
