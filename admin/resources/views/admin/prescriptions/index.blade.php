            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Prescription Requests</h6>
                </div>
                  ...
                  <table class="table align-items-center table-flush table-hover" id = "dataTableHover">
                    ...
                    @php $i=1;  @endphp
                      ...
                      <tr>
                        ...
                        <td>
                         <a href = "{{ URL::to('remove/prescriptions/'.$row->id) }}" class = "btn btn-danger  btn-sm" id = "delete"> <i class = "fa fa-trash"> </i> </a>
                        </td>
