...
@section('admin_contents')
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Delivery Done</h6>
                </div>
                    ...
                    @php $i=1;  @endphp
                      ...
                      <tr>
                        ...
                        <td>
                           ...
                           <a href = "{{ URL::to('view/prescriptions/orders/'.$row->id) }}" class = "btn btn-warning  btn-sm"> <i class = "fa fa-eye"> </i> </a>
  ...
  <!--  @else-->
  <!--   <div class = "text-center">-->
  <!--   <strong class = "badge badge-danger text-center" style = "font-size:20px;"> Product Canceled!! </strong>-->
  <!--  </div>-->
