            ...
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <ul>
                        ...
                        <li class="active">{{ $categorydetails->category_name }}</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-9">
                        <div class="shop-topbar-wrapper">
                            <div class="shop-topbar-left">
                                ...
                                <p>Showing 
                                        {{($categoryproducts->currentpage()-1)*$categoryproducts->perpage()+1}}  
                                    - 
                                        {{$categoryproducts->currentpage()*$categoryproducts->perpage()}} 
                                    of 
                                        {{$categoryproducts->total()}} results </p>
                            </div>
                        ...
                        <div class="shop-bottom-area">
                                                ...
                                                <div class="product-list-img">
                                                    ...
                                                    <div class="product-list-quickview">
                                                        ...
                                                        <button title="Quick View" 
                                                            ...
                                                            data-target-category="{{ $item->category_name }}"
                                                            data-target-image="{{ asset('assets/images/product/default.jpg') }}"
                                                            data-target="#productdescModal"><i class="icon-size-fullscreen icons"></i>
                            ...
                            <div class="pro-pagination-style text-center mt-10">
                                ...
                                {{ $categoryproducts->links('pagination.default') }}
                                <ul>
                    ...
                    <div class="col-lg-3">
                        <div class="sidebar-wrapper sidebar-wrapper-mrg-right">
                            <div class="sidebar-widget mb-40">
                                <img src="{{ asset('assets/images/banner/p8_OnlineMeds_HL1810_gi837647832.jpg') }}" style = "width:100%; height:250px;">
                            </div>
                            <div class="sidebar-widget mb-35 pt-40">
                                <div class="shop-catigory">
                                    <img src="{{ asset('assets/images/banner/mini-shopping-cart-full-homeopathic-remedies-1024266961.jpg') }}" style = "width:100%; height:250px;">
                                </div>
                            </div>
